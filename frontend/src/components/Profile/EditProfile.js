...
import {createProfile, getMyProfile} from '../../actions/profile/profile'
...
class CreateProfile extends Component {
    ...
    onSubmit(event) {
        ...
        const isCreateProfileFormInputsValid = this.validateCreatProfileFormInputs()



        if (isCreateProfileFormInputsValid) {
            const profileData = {
    ...
    validateCreatProfileFormInputs() {
        ...
        if(!skills){
            errors.skills = "Skill(s) is required"
        }
...
export default connect(mapStateToProps, {createProfile, getMyProfile})(withRouter(CreateProfile))